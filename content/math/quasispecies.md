...
![Two aligned ten-base sequences with three mismatched columns (G→T, C→G, C→A) highlighted; the Hamming distance is the count of differing columns, here three.](../assets/figures/hamming-distance.svg)
